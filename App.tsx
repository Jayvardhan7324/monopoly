                    ...
                    <div className="w-full max-w-sm flex flex-col items-center gap-4 relative">
                      <div className="flex flex-col items-center gap-1.5">
                        ...
                        <h1 className="text-5xl sm:text-6xl font-black tracking-tight text-center leading-[1.1] pb-1 px-2">
                          ...
                          <span className="bg-gradient-to-br from-indigo-400 via-violet-500 to-fuchsia-500 bg-clip-text text-transparent inline-block text-3xl sm:text-4xl align-baseline ml-1 font-black">.io</span>
                        </h1>
