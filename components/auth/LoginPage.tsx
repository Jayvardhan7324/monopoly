...
import { Mail, Lock, User, Chrome, ArrowRight, Eye, EyeOff, CheckCircle2 } from 'lucide-react';
      ...
      >
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl">
          ...
          <div className="flex flex-col gap-2 mb-5">
            ...
            >
              {loading === 'google' ? <Chrome className="h-4 w-4 opacity-60" /> : (
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 w-full py-2.5 rounded-xl border border-slate-700 bg-slate-800/80 hover:bg-slate-700 hover:border-slate-500 text-sm font-medium text-white transition-all disabled:opacity-50 active:scale-[0.98]"
            >
              {loading === 'apple' ? <CheckCircle2 className="h-4 w-4 opacity-60" /> : (
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 w-full py-2.5 rounded-xl border border-slate-700 bg-slate-800/80 hover:bg-slate-700 hover:border-slate-500 text-sm font-medium text-white transition-all disabled:opacity-50 active:scale-[0.98]"
            >
              {loading === 'discord' ? <CheckCircle2 className="h-4 w-4 opacity-60" /> : (
