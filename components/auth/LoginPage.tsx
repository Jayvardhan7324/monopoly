          ...
          <div className="flex flex-col gap-2 mb-5">
            ...
            >
              {loading === 'apple' ? <Loader2 className="h-4 w-4 animate-spin" /> : (
                <svg viewBox="0 0 814 1000" className="h-4 w-4" fill="currentColor">
                  <path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-36.8-162.8-107.6C141.4 737 79 577.5 79 430.3c0-216.3 141.4-330.7 280.8-330.7 75.2 0 137.7 49.2 184.4 49.2 44.5 0 114.7-52.4 197.7-52.4 31.7.1 108.2 9 163.8 80.1zm-139.5-83.4c16.9-19.5 29.3-46.8 29.3-74.1 0-3.7-.4-7.6-1.1-11.1-27.9 1.1-62 18.7-82.9 40.6-15.4 16.7-30.6 43.7-30.6 71.5 0 4.1.5 8.3 1.2 12.1 2.4.4 5 .6 7.5.6 25.4 0 57.1-16.9 76.6-39.7z"/>
                </svg>
              )}
              Continue with Apple
            </button>
