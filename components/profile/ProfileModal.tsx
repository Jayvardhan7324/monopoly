...
import { X, Trophy, Coins, LogOut, Calendar, Gamepad2, TrendingUp, Building2, Pencil, Check, AlertCircle, Skull } from 'lucide-react';
        ...
        {loading ? (
          <div className="flex flex-col gap-3 py-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              {[0, 1, 2, 3].map(i => <Skeleton key={i} className="h-16 rounded-xl bg-slate-800" />)}
            </div>
          </div>
        ) : profile ? (
          <>
