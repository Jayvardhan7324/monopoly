        ...
        if (cornerName === 'go to prison')
          return (
            <div className="flex flex-col items-center justify-center h-full w-full relative overflow-hidden bg-gradient-to-br from-[#3a1420] via-[#2a1020] to-[#1a0a18]">
              ...
              <div className="mt-0.5 inline-flex items-center bg-rose-500/20 px-1 rounded-[3px] border border-rose-500/40 leading-none h-[10px]">
                <span className="text-[7px] font-mono text-rose-300 font-bold uppercase tracking-wider leading-none">Busted!</span>
              </div>
            </div>
          );
        return null;
