...
interface ControlsProps {
  ...
  // BUG-FIX: onViewPlayer was used in App.tsx but missing from interface definition
            ...
            <div className="absolute inset-0 z-50 bg-[#0f172a]/95 backdrop-blur-md rounded-2xl border border-indigo-500/30 shadow-[0_0_100px_rgba(79,70,229,0.4)] animate-fade-in flex flex-col items-center justify-center p-4 overflow-hidden">
              ...
              <div className="w-full max-w-sm flex gap-4 mb-6">
                <button
                  ...
                  disabled={gameState.players[myPlayerId]?.money < (gameState.auction?.currentBid || 0) + GAME_CONSTANTS.MIN_AUCTION_INCREMENT || gameState.players[myPlayerId]?.isBankrupt}
                ...
                <button
                  ...
                  disabled={gameState.players[myPlayerId]?.money < (gameState.auction?.currentBid || 0) + 20 || gameState.players[myPlayerId]?.isBankrupt}
